...
var COMMON_ITEMS = [
  {
    title: '【{period}】家や、メンターがいない日の部室など、質問できる人がいない場所でも、学習を一人で進められた',
    help: 'この期間を振り返って答えてください。',
    low: '1 ほとんど進められなかった',
    high: '5 問題なく進められた'
  },
  {
    title: '【{period}】issue に取り組む中で、新しく学んだ概念を、人に説明できるレベルまで深く理解することができた',
    help: '「動かせた」ではなく「説明できる」かどうかで答えてください。',
    low: '1 ほとんどできなかった',
    high: '5 よくできた'
  },
  {
    title: '【{period}】分からないことを、自分で解決できた（ネット検索・AI利用等を含む）',
